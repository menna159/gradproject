...
class treatment_page extends StatefulWidget {
  const treatment_page({super.key});

  @override
  State<treatment_page> createState() => _treatment_pageState();
}

class _treatment_pageState extends State<treatment_page> {
  @override
